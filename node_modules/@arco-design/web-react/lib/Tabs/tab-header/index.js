...
var TabHeader = react_1.default.forwardRef(function (props, ref) {
    ...
    var renderAddIcon = function (isEditable) {
        return (isEditable &&
            showAddButton && (react_1.default.createElement("div", { className: prefixCls + "-add-icon", "aria-label": "add tab", tabIndex: 0, role: "button", onClick: handleAdd }, addButton || (react_1.default.createElement(icon_hover_1.default, { prefix: prefixCls + "-add" },
