...
var TabHeaderTitle = function (_a, ref) {
    ...
    return render(react_1.default.createElement("div", { ref: ref, key: tabKey, className: (0, classNames_1.default)(prefixCls + "-header-title", (_b = {},
        ...
        react_1.default.createElement("span", { className: prefixCls + "-header-title-text", role: "tab", "aria-selected": isActive, "aria-disabled": disabled || undefined, id: getIdPrefix(index).tab, "aria-controls": getIdPrefix(index).tabpane }, title),
        editable && (react_1.default.createElement("span", { role: "button", "aria-label": "remove tab", "aria-disabled": disabled || undefined, tabIndex: disabled ? -1 : 0, className: prefixCls + "-close-icon", onClick: function (e) {
                e.stopPropagation();
                if (disabled)
                    return;
                onDeleteTab(e);
            } }, deleteButton || react_1.default.createElement(icon_hover_1.default, { prefix: prefixCls }, deleteIcon || react_1.default.createElement(IconClose_1.default, null))))), {
        key: tabKey,
        isActive: isActive,
        disabled: disabled,
        editable: editable,
