...
function ResizeTrigger(props) {
    ...
    var classNames = (0, classNames_1.default)(prefixCls, prefixCls + "-" + (isHorizontal ? 'horizontal' : 'vertical'), (_a = {}, _a[prefixCls + "-not-resizable"] = !resizable, _a), className);
    var prevCollapsedConfig = (0, is_1.isObject)(collapsible.prev)
        ? __assign(__assign({}, collapsible.prev), { icon: collapsible.prev.icon || (isHorizontal ? react_1.default.createElement(IconCaretUp_1.default, null) : react_1.default.createElement(IconCaretLeft_1.default, null)) }) : {};
    var nextCollapsedConfig = (0, is_1.isObject)(collapsible.next)
        ? __assign(__assign({}, collapsible.next), { icon: collapsible.next.icon || (isHorizontal ? react_1.default.createElement(IconCaretDown_1.default, null) : react_1.default.createElement(IconCaretRight_1.default, null)) }) : {};
    ...
    return (react_1.default.createElement(resizeObserver_1.default, { onResize: onResize },
        react_1.default.createElement("div", { className: classNames, onMouseDown: onMouseDown }, (0, is_1.isFunction)(renderChildren)
            ? renderChildren(prev, trigger, next)
            : children || renderIcon())));
}
