...
function Split(props, ref) {
    ...
    return (react_1.default.createElement(Tag, { style: style, className: classNames, ref: wrapperRef },
        react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-pane", 'first-pane'), style: { flexBasis: getFirstPaneSize() }, ref: function (el) {
        ...
        react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-pane", 'second-pane'), ref: function (el) {
