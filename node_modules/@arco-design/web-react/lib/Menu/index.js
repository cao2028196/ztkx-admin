...
function Menu(baseProps, ref) {
    ...
    return (react_1.default.createElement("div", __assign({ id: mergedHasCollapseButton ? instanceId : undefined, role: "menu", tabIndex: 1 }, (0, omit_1.default)(rest, ['isMenu']), { ref: ref, style: usedStyle, className: (0, classNames_1.default)(prefixCls, prefixCls + "-" + theme, prefixCls + "-" + (mode === 'horizontal' ? 'horizontal' : 'vertical'), (_a = {},
