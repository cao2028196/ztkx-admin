...
var SubMenuPop = function (props) {
    ...
    var isActive = (0, hotkey_1.useHotkeyHandler)(_key, function () {
    ...
    var renderSuffix = function () {
        var MergedIconRight = icons && icons.popArrowRight ? icons.popArrowRight : react_1.default.createElement(IconRight_1.default, null);
    ...
    return (react_1.default.createElement(Dropdown_1.default, { trigger: "hover", onVisibleChange: function (visible) { return setPopupVisible(visible); }, droplist: react_1.default.createElement(index_1.default, { id: instanceId, selectedKeys: selectedKeys, onClickMenuItem: function (key, event) {
            ...
            } }, children), triggerProps: __assign({ position: needPopOnBottom ? 'bl' : 'rt', popupVisible: popupVisible, showArrow: true, autoAlignPopupMinWidth: true, classNames: 'fadeIn', duration: 100, mouseEnterDelay: 50, mouseLeaveDelay: 50, className: (0, classNames_1.default)(baseClassName + "-trigger", triggerProps && triggerProps.className) }, (0, omit_1.default)(triggerProps, ['className'])) },
        react_1.default.createElement("div", { "aria-haspopup": true, "aria-expanded": popupVisible, "aria-controls": instanceId, ref: forwardedRef, style: style, className: (0, classNames_1.default)(baseClassName, baseClassName + "-header", (_a = {},
