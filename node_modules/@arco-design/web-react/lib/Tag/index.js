...
function Tag(baseProps, ref) {
    ...
    return (react_1.default.createElement("div", __assign({ ref: ref, style: colorStyle, className: classNames }, otherProps),
        ...
        children,
        closable && !loading && closeIcon !== null && (react_1.default.createElement(icon_hover_1.default, { prefix: prefixCls, className: prefixCls + "-close-btn", onClick: onHandleClose, role: "button", "aria-label": "Close" }, closeIcon !== undefined ? closeIcon : react_1.default.createElement(IconClose_1.default, null))),
