...
function Carousel(baseProps, ref) {
    ...
    var _c = __read((0, react_1.useState)(typeof currentIndex === 'number' ? getValidIndex(currentIndex) : 0), 2), index = _c[0], setIndex = _c[1];
    var _d = __read((0, react_1.useState)(index), 2), previousIndex = _d[0], setPreviousIndex = _d[1];
