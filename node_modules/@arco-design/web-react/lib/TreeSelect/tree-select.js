...
var TreeSelect = function (baseProps, ref) {
    ...
    return (react_1.default.createElement(Trigger_1.default, __assign({ autoAlignPopupWidth: false, autoAlignPopupMinWidth: true, ref: triggerRef, classNames: "slideDynamicOrigin", trigger: "click", position: "bl", getPopupContainer: props.getPopupContainer, popupAlign: { bottom: 4 }, unmountOnExit: props.unmountOnExit }, props.triggerProps, { className: (0, classNames_1.default)(prefixCls + "-trigger", props.triggerProps && props.triggerProps.className), popup: function () {
            ...
            return (react_1.default.createElement("div", { className: prefixCls + "-popup", style: __assign({ maxHeight: ((_a = props.treeProps) === null || _a === void 0 ? void 0 : _a.height) || ((_c = (_b = props.treeProps) === null || _b === void 0 ? void 0 : _b.virtualListProps) === null || _c === void 0 ? void 0 : _c.height) ? 'unset' : '' }, props.dropdownMenuStyle) }, (0, is_1.isFunction)(dropdownRender) ? dropdownRender(dom) : dom));
        ...
        : props.triggerElement || (react_1.default.createElement(select_view_1.default, __assign({ ref: refSelectView }, props, { popupVisible: popupVisible, value: !multiple && (0, is_1.isArray)(value) ? value[0] : value, inputValue: inputValue, 
            // other
