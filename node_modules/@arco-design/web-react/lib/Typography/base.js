...
function Base(props) {
    ...
    var textWrapperRef = (0, react_1.useRef)(null);
    ...
    function calcEllipsis() {
        ...
        if (ellipsisConfig.rows) {
            ...
            setMeasuring(true);
            var _a = (0, utils_1.measure)(textWrapperRef.current || componentRef.current, ellipsisConfig, renderOperations(!!ellipsisConfig.expandable), children, simpleEllipsis), ellipsis_1 = _a.ellipsis, text = _a.text;
            setMeasuring(false);
            if (ellipsis_1 && text) {
    ...
    function wrap(content, component, props) {
        ...
        component.forEach(function (c, index) {
            ...
            currentContent = react_1.default.createElement(c, __assign(__assign({}, _props), _ref), currentContent);
        });
