...
function Pager(props) {
    ...
    return (react_1.default.createElement("li", __assign({ style: style, className: classnames, onClick: onClick, "aria-label": locale.Pagination.currentPage.replace('{0}', pageNum) }, ariaCurrentProps), itemRender ? itemRender(pageNum, 'page', pageNum) : pageNum));
}
...
var StepPager = function (props) {
    ...
    return (react_1.default.createElement("li", { style: pageItemStyle, className: cls, onClick: onClick, "aria-label": locale.Pagination[pageType] }, itemRender ? itemRender(undefined, pageType, StepIcon) : StepIcon));
};
