...
function InputNumber(baseProps, ref) {
    ...
    return (react_1.default.createElement(Input_1.default, __assign({ role: "spinbutton", "aria-valuemax": max, "aria-valuemin": min, "aria-valuenow": value }, (0, omit_1.default)(rest, ['allowClear']), inputEventHandlers, { style: style, className: (0, classNames_1.default)(prefixCls, prefixCls + "-mode-" + mode, prefixCls + "-size-" + mergedSize, (_a = {},
