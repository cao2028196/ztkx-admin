...
function Preview(props, ref) {
    ...
    var className = props.className, style = props.style, src = props.src, defaultVisible = props.defaultVisible, _c = props.maskClosable, maskClosable = _c === void 0 ? true : _c, _d = props.closable, closable = _d === void 0 ? true : _d, _e = props.breakPoint, breakPoint = _e === void 0 ? 316 : _e, actions = props.actions, _f = props.actionsLayout, actionsLayout = _f === void 0 ? [
        ...
        'originalSize',
        'extra',
    ] : _f, _g = props.getPopupContainer, getPopupContainer = _g === void 0 ? function () { return document.body; } : _g, onVisibleChange = props.onVisibleChange, _h = props.scales, scales = _h === void 0 ? getScale_1.defaultScales : _h, _j = props.escToExit, escToExit = _j === void 0 ? true : _j;
    var _k = (0, react_1.useContext)(previewGroupContext_1.PreviewGroupContext), previewGroup = _k.previewGroup, previewUrlMap = _k.previewUrlMap, currentIndex = _k.currentIndex, setCurrentIndex = _k.setCurrentIndex, infinite = _k.infinite;
    var mergedSrc = previewGroup ? previewUrlMap.get(currentIndex) : src;
    var _l = __read((0, react_1.useState)(mergedSrc), 2), previewImgSrc = _l[0], setPreviewImgSrc = _l[1];
    var _m = __read((0, useMergeValue_1.default)(false, {
    ...
    var _o = (0, useImageStatus_1.default)('loading'), isLoading = _o.isLoading, isLoaded = _o.isLoaded, setStatus = _o.setStatus;
    var _p = __read((0, react_1.useState)(false), 2), toolbarSimple = _p[0], setToolbarSimple = _p[1];
    var _q = __read((0, react_1.useState)({ x: 0, y: 0 }), 2), translate = _q[0], setTranslate = _q[1];
    var _r = __read((0, react_1.useState)(1), 2), scale = _r[0], setScale = _r[1];
    var _s = __read((0, react_1.useState)(false), 2), scaleValueVisible = _s[0], setScaleValueVisible = _s[1];
    var _t = __read((0, react_1.useState)(0), 2), rotate = _t[0], setRotate = _t[1];
    var _u = __read((0, react_1.useState)(false), 2), moving = _u[0], setMoving = _u[1];
    ...
    var _v = __read((0, react_1.useState)(), 2), container = _v[0], setContainer = _v[1];
