...
function Statistic(baseProps, ref) {
    ...
    var _b = __read((0, react_1.useState)('value' in props ? props.value : undefined), 2), value = _b[0], setValue = _b[1];
    ...
    return (react_1.default.createElement("div", { className: (0, classNames_1.default)("" + prefixCls, className), style: style },
        ...
        react_1.default.createElement("div", { className: prefixCls + "-content" },
            react_1.default.createElement(Skeleton_1.default, { animation: true, loading: !!loading, text: { rows: 1, width: '100%' } },
                react_1.default.createElement("div", { className: prefixCls + "-value", style: styleValue },
                    !(0, is_1.isNumber)(Number(value)) ? (value) : (react_1.default.createElement("span", { className: prefixCls + "-value-int" },
