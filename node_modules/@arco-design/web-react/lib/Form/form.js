...
var Form = function (baseProps, ref) {
    ...
    var _c = __read((0, useForm_1.default)(baseProps.form), 1), formInstance = _c[0];
    ...
    var contextProps = {
        ...
        validateMessages: (0, merge_1.default)({}, (_b = ctx.locale.Form) === null || _b === void 0 ? void 0 : _b.validateMessages, validateMessages),
