...
function TBody(props) {
    ...
    if (virtualized) {
        return (react_1.default.createElement("div", { className: prefixCls + "-body", ref: function (ref) { return saveVirtualWrapperRef(ref); } }, data.length > 0 ? (react_1.default.createElement(VirtualList_1.default, { data: data, height: scrollStyleY.maxHeight, isStaticItemHeight: false, style: __assign(__assign({}, scrollStyleX), { minWidth: '100%' }) }, function (child, index) { return (react_1.default.createElement(tr_1.default, __assign({}, trProps, { key: getRowKey(child), record: child, index: index, level: 0 }))); })) : (react_1.default.createElement("table", null,
