...
function Body(props) {
    ...
    var _a = (0, react_1.useContext)(context_1.default), utcOffset = _a.utcOffset, timezone = _a.timezone;
    ...
    function renderRow(row) {
        return row.map(function (col, index) {
            if (col.time) {
                var disabled_1 = (0, util_1.isDisabledDate)(col.time, disabledDate, mode, originMode);
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        showWeekList && (react_1.default.createElement(week_list_1.default, { prefixCls: prefixCls, dayStartOfWeek: dayStartOfWeek, isWeek: isWeek, CALENDAR_LOCALE: CALENDAR_LOCALE })),
