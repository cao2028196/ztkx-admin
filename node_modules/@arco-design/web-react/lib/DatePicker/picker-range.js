...
var Picker = function (baseProps) {
    ...
    (0, dayjs_1.initializeDateLocale)(locale.dayjsLocale, dayStartOfWeek);
    ...
    function onHandleChange(newValue) {
        if ((0, dayjs_1.isDayjsArrayChange)(mergedValue, newValue)) {
            var localValue = (0, is_1.isArray)(newValue)
                ? newValue.map(function (v) { return (0, dayjs_1.toLocal)(v, utcOffset, timezone); })
                : undefined;
            onChange &&
    ...
    function onSelectValueShow(newValueShow) {
        ...
        var zoneValues = sortedValues.map(function (v) { return (0, dayjs_1.toLocal)(v, utcOffset, timezone); });
        onSelect &&
