...
var Picker = function (baseProps) {
    ...
    (0, dayjs_1.initializeDateLocale)(locale.dayjsLocale, props.dayStartOfWeek);
    ...
    function onHandleSelect(_, date, now) {
        ...
        if (showTime) {
            ...
            var localTime = (0, dayjs_1.toLocal)(newTime, utcOffset, timezone);
            onSelect && onSelect(localTime.format(format), localTime);
        }
        else {
            var localTime = (0, dayjs_1.toLocal)(date, utcOffset, timezone);
    ...
    function onHandleChange(newValue) {
        if ((0, dayjs_1.isDayjsChange)(newValue, mergedValue)) {
            var localValue = (0, dayjs_1.toLocal)(newValue, utcOffset, timezone);
    ...
    function onTimePickerSelect(_, time) {
        ...
        var localNewValueShow = (0, dayjs_1.toLocal)(newValueShow, utcOffset, timezone);
    ...
    function onSelectNow() {
        var now = (0, dayjs_1.getNow)(utcOffset, timezone);
