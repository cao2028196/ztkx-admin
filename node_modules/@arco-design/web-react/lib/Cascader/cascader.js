...
function Cascader(baseProps, ref) {
    ...
    var _c = __read((0, react_1.useState)(function () {
        return 'value' in props
            ...
            : 'defaultValue' in props
                ...
                : [];
    }), 2), stateValue = _c[0], setValue = _c[1];
    ...
    (0, useUpdate_1.default)(function () {
        if ('value' in props && props.value !== stateValue) {
            var newValue = (0, util_1.formatValue)(props.value, isMultiple, store);
    ...
    var handleChange = function (newValue) {
        var _a;
        if ((0, is_1.isObject)(props.showSearch) && !props.showSearch.retainInputValueWhileSelect && isMultiple) {
            setInputValue('');
        }
    ...
    return (react_1.default.createElement(Trigger_1.default, __assign({ popup: renderPopup, trigger: props.trigger, disabled: disabled, getPopupContainer: getPopupContainer, position: "bl", classNames: "slideDynamicOrigin", popupAlign: { bottom: 4 }, 
        ...
        // other
        isEmptyValue: (0, util_1.isEmptyValue)(mergeValue), prefixCls: prefixCls, isMultiple: isMultiple, renderText: renderText, onRemoveCheckedItem: onRemoveCheckedItem, onClear: function (e) {
            e.stopPropagation();
            if (!isMultiple) {
                handleChange([]);
            }
