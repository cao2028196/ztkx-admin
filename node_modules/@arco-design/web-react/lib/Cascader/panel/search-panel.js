...
var SearchPanel = function (props) {
    ...
    return options.length ? (react_1.default.createElement("div", { className: prefixCls + "-list-wrapper" },
        react_1.default.createElement("ul", { role: "menu", onMouseMove: function () {
            ...
            return (react_1.default.createElement("li", { role: "menuitem", "aria-disabled": item.disabled, ref: function (node) {
