    ...
    return (react_1.default.createElement(react_transition_group_1.TransitionGroup, { component: react_1.default.Fragment }, menus.map(function (list, level) {
        ...
        return list.length === 0 && !showEmptyChildren ? null : (react_1.default.createElement(react_transition_group_1.CSSTransition, { key: level, timeout: {
            ...
            react_1.default.createElement("div", { className: prefixCls + "-list-column", style: { zIndex: menus.length - level } }, dropdownColumnRender(react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-list-wrapper", (_a = {},
                    ...
                    _a)) },
                list.length === 0 ? (renderEmpty && renderEmpty(120)) : (react_1.default.createElement("ul", { role: "menu", ref: function (node) { return setRefWrapper(node, level); }, className: (0, classNames_1.default)(prefixCls + "-list", prefixCls + "-list-select", (_b = {},
