...
function Divider(baseProps, ref) {
    ...
    var classNames = (0, classNames_1.default)(prefixCls, prefixCls + "-" + type, (_a = {},
        ...
        _a), className);
    return (react_1.default.createElement("div", { role: "separator", ref: ref, className: classNames, style: style }, children && type === 'horizontal' ? (react_1.default.createElement("span", { className: prefixCls + "-text " + prefixCls + "-text-" + orientation }, children)) : null));
}
