...
function Alert(baseProps, ref) {
    ...
    return (react_1.default.createElement(react_transition_group_1.CSSTransition, { in: visible, timeout: 300, classNames: "zoomInTop", unmountOnExit: true, onExited: function () {
        ...
        react_1.default.createElement("div", { ref: ref, style: style, className: classNames, role: "alert" },
            ...
            _closable && (react_1.default.createElement("button", { onClick: onHandleClose, className: prefixCls + "-close-btn" }, closeElement || react_1.default.createElement(IconClose_1.default, null))))));
}
