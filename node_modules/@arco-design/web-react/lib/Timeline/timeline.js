...
function Timeline(baseProps, ref) {
    ...
    return (react_1.default.createElement("div", __assign({ role: "list" }, rest, { ref: ref, className: (0, classNames_1.default)(prefixCls, prefixCls + "-" + mode, prefixCls + "-direction-" + direction, className), style: style }), items.map(function (child, index) {
        var _a;
        if (!child) {
            return null;
        }
