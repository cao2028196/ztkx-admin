...
function NodeList(props, ref) {
    ...
    return isVirtual ? (react_1.default.createElement(VirtualList_1.default, __assign({ className: className, style: style, ref: virtualListRef, data: childrenList, isStaticItemHeight: false, itemKey: getKey, onMouseDown: props.onMouseDown }, props.ariaProps, virtualListProps), function (item) {
