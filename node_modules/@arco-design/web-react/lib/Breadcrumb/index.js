...
function Breadcrumb(baseProps, ref) {
    ...
    return (react_1.default.createElement("div", __assign({ role: "list", ref: ref, style: style, className: (0, classNames_1.default)(prefixCls, className) }, (0, omit_1.default)(rest, ['itemRender'])), routes && routes.length ? getItemsByRoute() : getItemsByChildren()));
}
